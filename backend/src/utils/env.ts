...
export const env = {
  ...
  DIGITAL_OCEAN_REGION: process.env.DIGITAL_OCEAN_REGION || '',
  DIGITAL_OCEAN_SPACES_KEY_ID: process.env.DIGITAL_OCEAN_SPACES_KEY_ID || '',
  DIGITAL_OCEAN_SPACES_SECRET_ACCESS_KEY: process.env.DIGITAL_OCEAN_SPACES_SECRET_ACCESS_KEY || '',
